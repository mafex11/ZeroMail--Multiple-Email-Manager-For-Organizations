      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="text-center mb-16 mt-50">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h1 className="text-5xl font-bold doto-title">About Fusion Mail</h1>
          </div>
        ...
        <div className="max-w-4xl mx-auto mb-20">
          ...
          <div className="space-y-8 text-gray-300 leading-relaxed">
            <div className="bg-zinc-900/30 rounded-lg p-8 border border-gray-700">
            ...
            {/* <div className="bg-gray-900/40 rounded-lg p-8 border border-gray-700">
        ...
        <div className="max-w-6xl mx-auto mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-xl bg-zinc-900/30 border border-gray-700 hover:border-gray-600 transition-colors">
        ...
        {/* <div className="max-w-6xl mx-auto mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center p-8 rounded-xl bg-gray-900/50 border border-gray-700">
              ...
              <p className="text-gray-300 mb-3">Founder & CEO</p>
            ...
            <div className="text-center p-8 rounded-xl bg-gray-900/50 border border-gray-700">
              ...
              <p className="text-gray-300 mb-3">Machine Learning Engineers</p>
              <p className="text-gray-400 text-sm">
            ...
            <div className="text-center p-8 rounded-xl bg-gray-900/50 border border-gray-700">
              ...
              <p className="text-gray-300 mb-3">Privacy & Security Experts</p>
              <p className="text-gray-400 text-sm">
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">Numbers i want this to do..</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-xl bg-gradient-to-b from-zinc-800/50 to-zinc-900/30 border border-gray-700">
        ...
        {/* Contact CTA */}
        <div className="text-center p-12 rounded-2xl bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 border border-gray-700">
